...
class Tvm_Tracker_Settings {
    ...
    private function tvm_tracker_render_region_selector( $all_regions, $enabled_regions ) {
        ...
        $region_map = [
            ...
            'BR' => 'Brazil', 'ES' => 'Spain', 'IN' => 'India'
        ];

        ?>
        <div class="tvm-region-group is-open">
            <div class="tvm-region-header">
                <h3 style="margin: 0;"><?php esc_html_e('Section 1: Region Filters', 'tvm-tracker'); ?></h3>
    ...
    public function tvm_tracker_enabled_sources_render() {
        ...
        $type_order = [
            'sub' => esc_html__('Section 2: Subscription Services', 'tvm-tracker'),
            'free' => esc_html__('Section 3: Free Services', 'tvm-tracker'),
